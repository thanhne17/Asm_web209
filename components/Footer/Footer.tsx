...
const Footer = (props: Props) => {
  return (
    <footer className="bg-[#373839]">
      <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4 max-w-[1170px] mx-auto">
        <div>
      ...
      <div className="py-6 px-4 bg-[#272727] md:flex md:items-center md:justify-between">
