...
const Product = (props: Props) => {
    ...
    if (error) return <div className="h-[100vh] flex justify-center  items-center">
        <div id="toast-warning" className="flex items-center p-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
            ...
            <div className="ml-3 text-sm font-normal">Có lỗi xảy ra vui lòng thử lại sau</div>
    ...
    if (!data) return <div className='flex items-center justify-center h-[100vh]' role="status">
