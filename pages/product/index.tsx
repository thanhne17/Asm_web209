        ...
        <SiteLayout>
            <main className='py-4'>
                ...
                <div className="container grid gap-4 grid-cols-4  w-[1170px] mx-auto">
                    <div className="content-item-img border overflow-hidden hover:translate-y-[-5px] hover:shadow-md duration-200 shadow-lg ">
                        <div className="img">
                    ...
                    <div className="content-item-img border overflow-hidden hover:translate-y-[-5px] hover:shadow-md duration-200 shadow-lg  ">
                        <div className="img">
                            <img src="http://mauweb.monamedia.net/dogotaynguyen/wp-content/uploads/2018/07/27329839_1247039665425929_1166783542_o_109770_anh1-300x300.jpg"
                                className="w-[460px]" alt="" />
                        </div>
                        <div className="text-center pt-[20px] pb-[10px] opacity-75">
                            <h3>Bàn Ăn Gỗ Tự Nhiên Nguyên Tấm</h3>
                    ...
                    <div className="content-item-img border overflow-hidden hover:translate-y-[-5px] hover:shadow-md duration-200 shadow-lg ">
                        <div className="img ">
                            <img src="http://mauweb.monamedia.net/dogotaynguyen/wp-content/uploads/2018/07/b2a91bb6bcad5df304bc_109883_anhkhac0-300x300.jpg "
                                className="w-[460px] " alt="" />
                        </div>
                        <div className="text-center pt-[20px] pb-[10px] opacity-75">
                            <h3>Bàn Ăn Gỗ Tự Nhiên Nguyên Tấm</h3>
                    ...
                    <div className="content-item-img border overflow-hidden hover:scale-[0.96] duration-200 shadow-lg ">
                        <div className="img">
                            <img src="http://mauweb.monamedia.net/dogotaynguyen/wp-content/uploads/2018/07/b2a91bb6bcad5df304bc_109883_anhkhac0-300x300.jpg"
                                className="w-[460px]" alt="" />
                        </div>
