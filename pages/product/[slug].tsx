                            ...
                            <div className="mt-4 lg:mt-0 lg:row-span-3">
                                ...
                                <form className="mt-10">
                                    ...
                                    <div className="flex justify-between">
                                        <button
                                            type="submit"
                                            className="mt-10 mr-2 w-full bg-indigo-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                        >
                                            Thêm vào giỏ hàng
                                        </button>
                                        <button
