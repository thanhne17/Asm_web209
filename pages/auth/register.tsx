  ...
  return (
    <>
      <div ref={toartSuccess} id="toast-success" className="absolute top-5 right-5 flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 hidden" role="alert">
        ...
        <div className="ml-3 text-sm font-normal">Đăng kí tài khoản thành công.</div>
          ...
          >
            ...
            <div className="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="">
                  <h1 className='text-2xl font-semibold pb-4'>Đăng kí tài khoản mới</h1>
                </div>
                ...
                <div className="mb-6">
                  ...
                  />
                  {
                    ...
                    Object.keys(errors).length !== 0 && (
                      <>
                        {errors.name?.type === "required" && (<p className='text-[red]'>Tên không được bỏ trống</p>)}
                      </>
                    )}
                </div>
